    ...
    <div className=" w-full mt-7">
      ...
      <div className=" mx-auto flex flex-col justify-between items-center w-11/12 text-white max-w-maxContent ">
        <div className=" flex flex-col items-center gap-4 mx-auto">
          ...
          <div className=" font-semibold text-center text-2xl sm:text-3xl text-richblack-25 mt-5">
            Empower Your Future with
            <HilightText text={"Coding Skills"} />
          </div>
          <div className=" text-richblack-100 w-[90%] sm:w-[80%] lg:w-[65%] text-center mt-4">
            With our online coding courses, you can learn at your own pace, from
            anywhere in the world, and get access to a wealth of resources,
            including hands-on projects, quizzes, and personalized feedback from
            instructors.
          ...
          {/* button for call to an action */}
          <div className=" flex flex-row gap-4 sm:gap-8 mt-4">
            <CTAButton active={true} linkto={"/signup"}>
              Learn More
            </CTAButton>
        ...
        <div className=" flex flex-col items-center relative gap-6 w-full mt-16">
          ...
          <div className=" w-[90%] lg:w-[71%]  shadow-[15px_15px_rgba(255,255,255,0.90)]">
            <video
                muted
                loop 
                autoPlay 
      ...
      <div className=" bg-pure-greys-5 text-richblack-700 ">
        {/* square white photo bg with button */}
        <div className=" homepage-bg h-[10rem] sm:h-[12rem]">
          <div className=" w-11/12 flex flex-row justify-center gap-8 mx-auto">
                <div className=" flex flex-col sm:flex-row gap-4 sm:gap-6 mt-[3rem] sm:mt-[5rem] items-center">
                
                    <CTAButton active={true} linkto="/signup">
                        <div className=" flex flex-row gap-3 items-center justify-center text-sm sm:text-base">
                            Explore Full Catalog
                            <FaArrowRight/>
                        </div>
                    </CTAButton>
        ...
        {/* white bg  */}
        <div className=" flex w-11/12 max-w-maxContent items-center flex-col justify-center gap-10 mx-auto mt-20">
          <div className=" flex flex-col lg:flex-row justify-center gap-8 lg:gap-40 mx-auto">
            <div className=" w-full lg:w-[50%] text-left">
              <h1 className=" font-inter font-semibold text-2xl sm:text-4xl">
                Get the skills you need for 
                <HilightText text={'a job that is in demand.'}/>
              </h1>
            </div>
            <div className=" flex flex-col gap-6 lg:gap-12 w-full lg:w-[50%]">
              <p className=" text-left text-richblack-600 font-inter font-medium text-base sm:text-lg ">
                The modern StudyNotion is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
              </p>
              <CTAButton active={true} children={'Learn More'} linkto='/login'/>
            </div>
