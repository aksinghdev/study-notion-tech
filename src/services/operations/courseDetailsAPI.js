...
export const getAllCourses = async () =>{
    ...
    let result;
    try{
        const responce = await apiConnector("GET",GET_ALL_COURSE_API)
        if(!responce?.data?.success){
            throw new Error("Could not get all courses")
        }
        // console.log("get all catgories responce",responce);
...
export const fetchCourseCategories = async () => {
  ...
  try {
    ...
    console.log("COURSE_CATEGORIES_API API RESULT............", result);
  } catch (error) {
...
export const createSection = async (data, token) => {
  let result = null
  console.log("print data inside create section thunk:---",data)
  const toastId = toast.loading("Loading...")
  try {
...
export const deleteCourse = async (data, token) => {
  const toastId = toast.loading("Loading...")
  console.log("Print Course Id and token : ",data,"  token : ",token);
  try {
