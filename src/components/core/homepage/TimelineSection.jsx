...
export default function TimelineSection(){
    return(
        <div className=" flex flex-col lg:flex-row gap-14 lg:gap-20 justify-between items-center ">
            <div className=" flex flex-col gap-10 items-start justify-evenly w-full lg:w-[45%]">
              {
                timeline.map( (element, index) =>{
                  return(
                    <div className=" flex flex-row gap-10 items-start relative" key={index}>
            ...
            <div className=" relative shadow-richblue-200 flex justify-center items-center w-full lg:w-auto mt-4 lg:mt-0 pb-10 lg:pb-0">
                <img src={timelineimage} className=" h-fit z-10 w-full lg:w-auto"/>
              <div className=" w-[300px] sm:w-[655px] h-[250px] sm:h-[420px] rounded-full blur-2xl bg-blue-300 absolute top-8 right-0 opacity-60">
              </div>
              <div className=" w-[90%] lg:w-[70%] flex flex-row gap-4 sm:gap-12 bg-caribbeangreen-700 absolute bottom-[-30px] sm:bottom-[-37px] z-20 p-3 sm:p-6 items-center justify-items-center">
                <div className=" flex flex-row text-center justify-center items-center gap-2 sm:gap-4">
                  <h2 className=" text-richblack-5 text-2xl sm:text-4xl font-inter font-bold"> 10</h2>
                  <p className=" text-xs sm:text-sm text-start font-inter text-caribbeangreen-300">YEARS EXPERINECE</p>
                </div>
                <div className=" w-8 sm:w-16 h-[1px] border border-caribbeangreen-500 rotate-90 bg-caribbeangreen-200"></div>
                <div className=" flex flex-row text-center justify-center gap-2 sm:gap-4">
                  <h2 className="text-richblack-5 text-2xl sm:text-4xl font-inter font-bold">250</h2>
                  <p className="text-xs sm:text-sm text-start font-inter text-caribbeangreen-300">
                    TYPES OF COURSES
                  </p>
                </div>
