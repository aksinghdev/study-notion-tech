    ...
    return(
        <div className=" w-11/12 flex items-center justify-center mx-auto">
            <div className=" flex flex-col lg:flex-row gap-6 lg:gap-16 justify-center items-center">
                <div className=" p-0 lg:p-16 w-full lg:w-[50%]">
                    <img src={becomeaninstructorimg}
                        className=" shadow-[-15px_-15px_rgba(255,255,255,0.90)]"
                    />
                </div>
                <div className=" flex flex-col gap-5 w-full lg:w-[45%] text-center lg:text-left items-center lg:items-start">
                    <h1 className=" text-2xl sm:text-3xl font-bold font-inter w-full sm:w-[80%] ">
                        Become<br/>
                        <HilightText text="an Instructor"/>
                    </h1>
                    <p className=" text-richblack-300 font-medium font-inter text-sm sm:text-base w-full sm:w-[80%]">
